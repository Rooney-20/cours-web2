...
//router pour afficher une boisson par son id
...
//router pour filtrer les boissons par prix
router.get("/", (req, res) => {
  const drinks = parse(jsonDbPath, defaultDrinks);
...
//router pour supprimer une boisson
...
//router pour ajouter une nouvelle boisson
router.post("/", (req, res) => {
...
//router pour modifier une boisson
